...
import { FiPrinter, FiFileText, FiX, FiPlus, FiThermometer, FiBatteryCharging, FiZap, FiSun, FiAward, FiSmartphone, FiTag } from 'react-icons/fi'
import { getInstallmentPlanSheet, getPriceSheet, getAcceptanceLetter, getCompletionLetter, getInternshipCertificate,
...
/**
 * Everything the shop prints on paper: the price and installment sheets handed
 * to customers, and the letters a student on attachment needs.
 *
 * Nothing here records a sale or moves stock. That is the whole point of the
 * page, and it is why the packages receipt was moved out of it — printing one
 * of those takes money, which is not a document.
 */

/**
 * The two kinds of thing this page prints. Grouped because it had grown into
 * one long scroll of unrelated cards, and hunting past one to reach the other
 * is how people conclude a feature is missing.
 */
const SECTIONS = [
...
export default function ReceiptForms() {
  ...
  // Which sheet is being prepared, so only that card shows a spinner.
